...
import com.crm.payment.factory.CodPaymentFactory;
import com.crm.payment.factory.StripePaymentFactory;
import com.crm.inventory.event.InventoryEventManager;

// make thiis shit interactive , user input
public class Main {
        ...
        private static void testPaymentSystem() {
                ...
                // Demo 1: Controller using a specific Factory (CardPaymentFactory)
                ...
                payCtrl.processPayment(transaction1, new CardPaymentFactory());
                ...
                PaymentTransaction transaction2 = new PaymentTransaction("TXN-002", "ORD-999", new Money(50.0, "USD"),
                                PaymentMethodType.Card);
                // The controller will automatically use StripePaymentFactory for Card method
                payCtrl.processPayment(transaction2, new StripePaymentFactory());

                // Demo 3: Cash On Delivery
                System.out.println("\n--- Demo 3: Cash On Delivery ---");
                PaymentTransaction transaction3 = new PaymentTransaction("TXN-003", "ORD-555", new Money(75.0, "USD"),
                                PaymentMethodType.CashOnDelivery);
                payCtrl.processPayment(transaction3, new CodPaymentFactory());
