...
public class InventoryApiServer {
    ...
    public static void start(ProductController productController, InventoryController inventoryController) {
        try {
            HttpServer server = HttpServer.create(new InetSocketAddress(PORT), 0);
            server.createContext("/api/v1/inventory/products", new ProductHandler(productController, inventoryController));
    ...
    static class ProductHandler implements HttpHandler {
        ...
        public ProductHandler(ProductController productController, InventoryController inventoryController) {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equals(method)) {
                ...
                try {
                    ...
                    inventoryController.createInventoryRecord(newRecord);
